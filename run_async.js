...
async function guess_once(nround, all_d, num_d) {
	var cur_res;
...
async function start_guess(all_d, num_d){
	...
	while(nround != -1){
		nround = await guess_once(nround, all_d, num_d);
	}
}
